// Based on the example from the previous lesson, you can work directly in the browser or create separate HTML/JavaScript files – choose a more convenient option. 
